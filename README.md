...
<body>
    ...
    <script type="text/babel" data-type="module">
        ...
        import { 
            ...
            Info, Activity, ArrowRight, ArrowDown, Thermometer, AlertTriangle, 
            Star, Heart, Shield, GraduationCap, Briefcase, Network, ChevronDown, 
            Gavel, ClipboardList, CameraOff, Volume2, Coffee, Stethoscope, 
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6 text-stone-800">
          <section>
            <h3 className="text-xl font-bold text-emerald-700 mb-3">13.1. Quy trình Bảo trì Kỹ thuật (Maintenance)</h3>
            <div className="bg-white p-4 rounded-lg border border-stone-200 shadow-sm mb-4">
              <h4 className="font-bold text-stone-800 mb-3 flex items-center gap-2"><Zap size={18}/> Checklist kiểm tra hàng ngày</h4>
              <ul className="list-disc pl-5 text-sm text-stone-700 space-y-2">
                 <li><strong>Hệ thống Xông hơi (Sauna & Steam):</strong> Kiểm tra hoạt động của lò xông, dây mayso, hệ thống phun hơi và bảng điều khiển nhiệt độ trước giờ mở cửa 30 phút.</li>
                 <li><strong>Hệ thống Nước (Pools):</strong> Kiểm tra bơm, lọc, nhiệt độ hồ nóng/lạnh và hóa chất xử lý nước. Đảm bảo không rò rỉ.</li>
                 <li><strong>Điện & Ánh sáng:</strong> Kiểm tra toàn bộ bóng đèn, ổ cắm và hệ thống âm thanh tại các khu vực hành lang, phòng trị liệu.</li>
                 <li><strong>Điều hòa & Thông gió (HVAC):</strong> Đảm bảo nhiệt độ khu vực chung 24-26°C, không có mùi lạ từ cửa gió.</li>
              </ul>
            </div>

            <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-200 shadow-sm">
               <h4 className="font-bold text-emerald-800 mb-3 flex items-center gap-2"><ClipboardList size={18}/> Quy trình Tiếp nhận & Sửa chữa sự cố</h4>
               <div className="space-y-4 text-sm text-stone-700">
                  
                  <div className="flex gap-3 items-start">
                     <div className="bg-emerald-600 text-white w-6 h-6 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold mt-0.5">1</div>
                     <div>
                        <strong>Tiếp nhận thông tin:</strong>
                        <p className="text-xs text-stone-600 mt-1">Nhận yêu cầu từ các bộ phận vận hành (qua Group Zalo/Bộ đàm hoặc sổ theo dõi kỹ thuật). Xác nhận thời gian tiếp nhận.</p>
                     </div>
                  </div>

                  <div className="flex gap-3 items-start">
                     <div className="bg-emerald-600 text-white w-6 h-6 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold mt-0.5">2</div>
                     <div>
                        <strong>Khảo sát & Đánh giá:</strong>
                        <p className="text-xs text-stone-600 mt-1">Có mặt tại hiện trường trong vòng <strong>5-10 phút</strong>. Kiểm tra thực tế lỗi. <br/>
                        - Nếu sửa được ngay &rarr; Chuyển B3.<br/>
                        - Nếu cần thay thế vật tư/thuê ngoài &rarr; Lập đề xuất trình Giám đốc duyệt.</p>
                     </div>
                  </div>

                  <div className="flex gap-3 items-start">
                     <div className="bg-emerald-600 text-white w-6 h-6 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold mt-0.5">3</div>
                     <div>
                        <strong>Thực hiện sửa chữa:</strong>
                        <ul className="list-disc pl-4 mt-1 text-xs text-stone-600">
                           <li>Đặt biển cảnh báo <strong>"Khu vực đang bảo trì"</strong> để đảm bảo an toàn cho khách.</li>
                           <li>Cô lập nguồn điện/nước (Lockout/Tagout) nếu cần thiết.</li>
                           <li>Tiến hành sửa chữa theo đúng tiêu chuẩn kỹ thuật.</li>
                        </ul>
                     </div>
                  </div>

                  <div className="flex gap-3 items-start">
                     <div className="bg-emerald-600 text-white w-6 h-6 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold mt-0.5">4</div>
                     <div>
                        <strong>Nghiệm thu & Bàn giao:</strong>
                        <p className="text-xs text-stone-600 mt-1">Vận hành thử tải để đảm bảo thiết bị hoạt động ổn định. Vệ sinh sạch sẽ khu vực sửa chữa. Bàn giao lại cho bộ phận vận hành sử dụng.</p>
                     </div>
                  </div>

                  <div className="flex gap-3 items-start">
                     <div className="bg-emerald-600 text-white w-6 h-6 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold mt-0.5">5</div>
                     <div>
                        <strong>Báo cáo:</strong>
                        <p className="text-xs text-stone-600 mt-1">Ghi chép nội dung công việc, nguyên nhân hư hỏng và vật tư đã thay thế vào Nhật ký kỹ thuật (Logbook).</p>
                     </div>
                  </div>
          ...
          <section>
            <h3 className="text-xl font-bold text-emerald-700 mb-3">13.2. Quy trình Ứng phó Y tế (Emergency Response)</h3>
            <div className="grid md:grid-cols-2 gap-4">
               {/* Code Blue */}
          ...
          <section>
            <h3 className="text-xl font-bold text-emerald-700 mb-3">13.3. Phòng cháy chữa cháy (PCCC)</h3>
            <div className="bg-orange-50 p-4 rounded-lg border border-orange-200 shadow-sm">
          ...
          <section>
            <h3 className="text-xl font-bold text-emerald-700 mb-3">13.4. An ninh & An toàn tài sản</h3>
           ...
           <section>
            <h3 className="text-xl font-bold text-emerald-700 mb-3">13.5. Báo cáo vấn đề cho Quản lý</h3>
            <div className="bg-white p-4 rounded border border-stone-200 shadow-sm">
               <h4 className="font-bold text-stone-800 flex items-center gap-2 mb-3">
                  <MessageSquare size={20}/> Nội dung báo cáo hàng ngày
               </h4>
           ...
           <section>
            <h3 className="text-xl font-bold text-emerald-700 mb-3">13.6. Checklist Bảo trì Kỹ thuật (Maintenance Checklist)</h3>
