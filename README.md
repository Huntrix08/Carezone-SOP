...
<head>
    ...
    <title>Carezone SOP (Phiên bản Ổn định)</title>
    ...
    <style>
        ...
        .loading-screen { position: fixed; inset: 0; display: flex; justify-content: center; align-items: center; background: white; z-index: 50; }
    </style>
</head>
<body class="bg-stone-50 text-stone-900">
    ...
    <div id="root">
        <div class="loading-screen">
            <div class="text-emerald-600 font-bold text-xl animate-pulse">Đang tải dữ liệu Carezone...</div>
        </div>
    </div>

    <script type="text/babel" data-type="module">
        // Import React và Icon trực tiếp từ Cloud (Không cần thẻ script lằng nhằng)
        import React, { useState, useEffect, useRef } from 'https://esm.sh/react@18.2.0';
        import { createRoot } from 'https://esm.sh/react-dom@18.2.0/client';
        
        // Import gói Icon đầy đủ
        import * as LucideIcons from 'https://esm.sh/lucide-react@0.292.0';

        // Lấy các icon cần thiết từ gói đã tải
        const { 
